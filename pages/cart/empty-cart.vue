                ...
                <div class="row">
                    <div class="col-lg-6 offset-lg-3 col-md-6 offset-md-3 col-sm-12 col-12">
                        <div class="empaty_cart_area">
                            ...
                            <h3>Sorry... No Item Found Inside Your Cart!</h3>
                            <nuxt-link to="/shop/shop-4" class="btn btn-black-overlay btn_md">Continue Shopping</nuxt-link>
                        </div>
                    </div>
                </div>
            </div>
        ...
        meta: [
          {
            hid: 'empty cart',
            name: 'empty cart',
            content: 'Empty Cart page - Purple Pearl Jewellery'
          }
        ]
      }
    }
