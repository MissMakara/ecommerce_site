<template>
  <div>
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-6 col-md-12">
                    <div class="product_shot_view">
                        <ul>
                            ...
                            <li><nuxt-link to="/shop/shop-4" class="active"><i class="fas fa-th"></i></nuxt-link></li>
                        </ul>
                    </div>
                ...
                <div class="col-lg-6 col-md-12">
                    <div class="product_shot">
                        ...
                        <div class="customs_selects">
                            <select name="product" class="customs_sel_box"  v-model="sortOptions" @change="checkOptions">
            ...
            <div class="row">
                ...
                <div class="col-lg-9">
                    ...
                    <div class="row">
                        <div class="col-lg-4 col-md-4 col-sm-6 col-12" v-for="(product,index) in productslist" :key="product.id" v-show="setPaginate(index)">
                            <ProductBox5 :product="product" :index="index" @showalert="alert" @alertseconds="alert" />
                        </div>
                            ...
                            <div class="product-pagination mb-0" v-if="productslist.length > this.paginate ">
                                <nav aria-label="Page navigation">
                                    <ul class="pagination">
                                        ...
                                        <li class="page-item" v-for="(page_index, j) in this.pages" :key="j" :data-index="j" :class="{'active': page_index == current}">
                                            <a
                                                class="page-link"
    ...
    >
      <p class="font-weight-normal">Successfully added to your cart</p>
    </b-alert>
    <!-- Add to cart Alert / Notification  -->
    ...
    <b-alert
      ...
      @dismiss-count-down="alert"
    >
      <p class="font-weight-normal">Successfully added to your wishlist</p>
    </b-alert>
    <!-- Add to wishlist / wishlist Notification  -->
...
<script >
console.log("SHOP 4 page loaded]")
...
export default {
    ...
    methods: {
        ...
        checkOptions(){
            if (this.sortOptions.includes('low')){
                this.$store.dispatch('products/sortPriceAsc', this.sortOptions) 
            }
            else if(this.sortOptions.includes('high')){
                this.$store.dispatch('products/sortPriceDesc', this.sortOptions) 
            }
