  ...
  <div>
    ...
    <section id="shop_main_area" class="ptb-100">
        <div class="container">
            <div class="row">
                ...
                <div class="col-lg-6 col-md-12">
                    <div class="product_shot">
                        ...
                        <div class="customs_selects">
                            <select name="product" v-model="sortOptions" class="customs_sel_box" @change="checkOptions">
                        ...
                        <div class="product_shot_view">
                            <ul>
                                ...
                                <li><nuxt-link to="/shop/shop-4"><i class="fas fa-th"></i></nuxt-link></li>
                            </ul>
                        </div>
                    </div>
                </div>
            ...
            <div class="row">
                <div class="col-lg-4 col-md-4 col-sm-6 col-12" v-for="(product,index) in productslist" :key="index" v-show="setPaginate(index)">
