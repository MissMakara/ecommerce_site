<template>
  <div class="home-page">
      ...
      <div class="container">
        <div class="row">
          ...
          <!-- <div class="col-lg-6">
            <div class="hero_img">
              <img
                :src="require('@/assets/img/common/man.jpg')"
                alt="img"
                class="slideInRight"
                style="animation-duration: 3s; animation-delay: 0.3s"
              />
        ...
        <div class="row">
          <div class="col-lg-4 col-md-6">
            <div class="product_variation_one_boxed img-zoom-hover">
              <img :src="require('@/assets/img/offer/woman.jpg')" alt="img" />
              <div class="product_var_one_text">
                <h4 class="color_one">New Arrivals</h4>
                <!-- <h2>New</h2>
                <h4>Collection</h4> -->
                <nuxt-link
                  to="/shop/shop-4"
            ...
            <div class="product_variation_one_boxed img-zoom-hover">
              <img :src="require('@/assets/img/offer/woman1.jpg')" alt="img" />
              <div class="product_var_one_text">
                <h4 class="color_one">Jewellery Sets</h4>
                <!-- <h2>Hot</h2>
                <h4>Collection</h4> -->
          ...
          <div class="col-lg-4 col-md-6">
            <div class="product_variation_one_boxed img-zoom-hover">
              <img :src="require('@/assets/img/offer/bag.jpg')" alt="img" />
              <div class="product_var_one_text_center">
                <h2 class="color_one">Earrings</h2>
          ...
          <div class="col-lg-4 col-md-6">
            <div class="product_variation_one_boxed img-zoom-hover">
              <img :src="require('@/assets/img/offer/woman4.jpg')" alt="img" />
              <div class="product_var_one_text">
                <!-- <h2>New</h2>
                <h4 class="color_one">Arrivals</h4> -->
                <h4 class="color_one">Rings</h4>
                <nuxt-link
                  to="/shop/shop-4"
                  class="theme-btn-one bg-black btn_sm"
                  >Shop Now</nuxt-link
            ...
            <div class="product_variation_one_boxed img-zoom-hover">
              <img :src="require('@/assets/img/offer/kids.jpg')" alt="img" />
              <div class="product_var_one_text">
                <!-- <h2>Hot</h2> -->
                <h4 class="color_one">Watches</h4>
    ...
    <b-alert
      ...
      @dismiss-count-down="alert"
    >
      <p class="font-weight-normal">Successfully added to your compare list</p>
    </b-alert>
    <!-- Add to Compare / Compare Notification  -->
  </div>
</template>
      ...
      meta: [
        {
          hid: "description",
          name: "description",
          content: "Home page Purple Pearl Jewellery",
        },
      ],
    };
  },
