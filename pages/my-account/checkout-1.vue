                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-6 col-md-12 col-sm-12 col-12">
                                        <div class="form-group">
                                            ...
                                            <input type="text" v-model="order.firstName" id="fname" name="fname" class="form-control" placeholder="First name *" required />
                                            <!-- <input type="text" v-model="order.firstName" id="fname" name="fname" class="form-control" placeholder="First name *" :class="{ 'is-invalid': submitted && $v.user.fname.$error }" /> -->
                                    ...
                                    <div class="col-lg-6 col-md-12 col-sm-12 col-12">
                                        <div class="form-group">
                                            ...
                                            <input type="text" v-model="order.lastName" id="lname" name="lname" class="form-control" placeholder="Last name *" required />
                                            <!-- <input type="text" v-model="order.lastName" id="lname" name="lname" class="form-control" placeholder="Last name *" :class="{ 'is-invalid': submitted && $v.user.lname.$error }" /> -->
                                    ...
                                    <div class="col-lg-12 col-md-12 col-sm-12 col-12">
                                        <div class="form-group">
                                            ...
                                            <input type="contact" v-model="order.contact" id="contact" name="contact" class="form-control" placeholder="Enter a phone number we can contact you through" required/>
                                            <!-- <div v-if="submitted && $v.user.email.$error" class="invalid-feedback"> -->
                                            <div>  
                                                <!-- <span v-if="!$v.user.email.required">Phone number is required</span> -->
                                                <!-- <span v-if="!$v.user.email.email">Email is invalid</span> -->
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-lg-6 col-md-12 col-sm-12 col-12">
                                        <div class="form-group">
                                            <label for="location">General Delivery Location</label>
                                            <select class="country_option nice-select wide form-control"
                                                v-model="order.location" name="location" id="location" required >
                                                <option v-for="destination in destinations" :key="destination.id" :value="destination.destination" >{{destination.destination}}</option>
                                                
                                            </select>
                                        <!-- <div v-if="submitted && !$v.user.country.required" class="invalid-feedback">Location is required</div>-->
                                        </div>
                                    </div>
                                    <div class="col-lg-12 col-md-12 col-sm-12 col-12">
                                        <div class="form-group">
                                            <label for="faddress">Full Address</label>
                                            <textarea type="text" class="form-control" v-model="order.address" id="faddress"
                                                placeholder="Enter your address: ie Exact location, Apartment no/suite no...">
                                            </textarea>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-lg-12 col-md-12 col-sm-12 col-12">
                                        <div class="form-group">
                                            ...
                                            <br>
                                            <i>Any Additional Delivery Instructions</i>
                                            <textarea rows="5" class="form-control" v-model="order.additionalNotes" id="messages"
                                ...
                                <table class="table">
                                    ...
                                    <tbody>
                                        <tr v-for="(product,index) in cartItems" :key="product.id">
                                            <!-- <td >{{product.title}}<span class="product-qty"> x  {{product.quantity}}</span>
                                            </td> -->
                                            <td >{{product.title}}</td>
                                    ...
                                    <tfoot>
                                        <tr v-if="cartItems.length" >
                                            <th>SubTotal</th>
                                            <td> </td>
                                            <td class="product-subtotal"> {{this.cartTotals}}</td>
                                        </tr>
                                        <tr v-else>
                        ...
                        <div class="order_review bg-white">
                                ...
                                <table class="table">
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td>{{this.cartTotals}}</td>
                                        </tr>
                                        <tr>
                                            <td>Shipping</td>
                                            <td>{{ this.shippingRate }}</td>
                                        </tr>
                            ...
                            <div class="payment_method">
                                <div class="payment_option">
                                    <div>
                                        <label class="form-check-label"><b>MPESA</b></label>
                                        <p class="form-check-label">Pay via MPESA TILL NUMBER <br>
                                            629183465 <br>
                                            Purple Pearl Jewellery
                                            <br>
                                            <br>
                                            Once you make the payment, enter the code below <br>
                                        ...
                                        placeholder="Enter MPESA confirmation code here.. " required/>
...
export default {
    ...
    console.log('location updated to ', this.order.location + ' !')
    // this.getShippingRate()
    ...
    computed:{
        ...mapState({
            ...
            searchproducts: state => state.products.searchedProduct,
            productslist: state => state.products.productslist,
            destinations: state =>state.cart.destinations,
        }),
    },
    mounted() {
        ...
        this.cartTotals = this.getCartTotals()
    ...
    methods: {
        ...
        getCartTotals(){
            ...
            for (let x in this.cartItems){
                let qtty = this.cartItems[x].quantity
                let price = this.cartItems[x].price
                console.log(price, qtty)
                this.totalPrice += ((price) * (qtty))
        ...
        getShippingRate(){
            for (let index in this.destinations){
                // console.log("dest",this.destinations[index].destination)

                // console.log("loc",this.order.location)
                if (this.destinations[index].destination === this.order.location){

                    console.log("The shipping rate is ", this.destinations[index].price)
                    this.shippingRate =this.destinations[index].price
                    return this.shippingRate
                }
            }
        },
        getTotalAmount(){
            let totalAmount= parseFloat(this.shippingRate) + this.cartTotals
