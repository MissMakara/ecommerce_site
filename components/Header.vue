                ...
                <div class="main-menu menu-color--black menu-hover-color--golden">
                  <nav>
                    <ul>
                      ...
                      <li>
                        <a href="/shop/shop-4">New Arrivals</a>
                      </li>
                      <li>
                        <a href="/shop/shop-4">Shop</a>
                      </li>


 <!--STARTS HERE-->                     
                      <li class="has-dropdown has-megaitem">
                        <a href="#">Options<i class="fa fa-angle-down"></i></a>
                        <!-- Mega Menu -->
                        <div class="mega-menu">
    ...
    <b-sidebar id="search_sidebar" backdrop>
      ...
      >
        ...
        >
          ...
          <ul v-if="searchedProduct.length" class="search-results-wrap">
            <li v-for="(product, index) in searchedProduct" :key="index">
...
export default {
  ...
  computed: {
    ...mapState({
      ...
      searchedProduct: state =>state.products.searchedProduct
    }),
    ...mapGetters({
      cart: "cart/cartItems",
